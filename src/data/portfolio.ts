...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary: "Interactive developer portfolio with a desktop-style UI, draggable windows, and live Spotify integration.",
    description: "Built a responsive portfolio website using Next.js, React, Tailwind CSS, and Framer Motion. The site showcases profile details, projects, skills, and interactive window-based navigation with dynamic theme support.",
    techStack: ["Next.js", "React", "Tailwind CSS", "Framer Motion", "GSAP", "TypeScript","WebGL"],
